...
## Garbage entropy
There seems to be three main problems in waste management: collection, sorting, and processing. There are sub-problems within each categories.

### Collection
* Household collection - Private or public?
* Public collection. How should bins be spaced apart? I think it would be an interesting monitoring problem. 
...
### Sorting
The trend from reading about and visiting these places seems to be that both municipalities and private organizations push the public to sort waste as much as possible before it goes to the facility.

There are now a number of 
Scalability and durability are the name of the game in recycling robotics (unlike precision and reliability in the world of say, medical robotics -- it's interesting how vastly priorities differ based on the task).

Daisy Apple's product & Ewaste difficulty

### Processing
Burning, landfills, or acid
...
Go to search term "ways different countries process trash".
